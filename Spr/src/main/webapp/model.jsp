...
<img src="resources/images/logo.png" alt="Italian Trulli"  >
   <h1 style="display:inline-block;">Data Submitted Successfully for <span style="color:grey;"><u></br>Plant:-{{user_plant_no}}/Model</u></span></h1>
    ...
    <div id="page-wrapper">
            ...
            <div class="container">
                <nav aria-label="breadcrumb">
                 ...
                 <input type="button" value="LOGOUT"  display:inline-block;" ng-click="logout()">
                       ...
                       <center> <h1  aria-current="page">Add New Model</h1>
                    </center>
                </nav>
            </div>
        </div>
        ...
        <section class="wthree-row pt-0 pb-5 w3-contact">
            <div class="container py-sm-1 pt-0 pb-5">
                ...
                <div class="row ">
                    <div class="col-lg-12 wthree-form-left">
                        ...
                        <div class="contact-top1">
                           ...
                           <form action="#" method="post" name="model_form">
				<div class="contact-grids1 w3agile-6">
					<div class="row">
					<div class="col-md-4 col-sm-6 contact-form1 form-group">
							<label class="col-form-label">Company</label>
							<select type="text" class="form-control" name="company" ng-model="company" placeholder="" required>
						<option value="" hidden>Select for the company</option>
							 <option value="Ppap">PPAP</option>
    <option value="Pti">PTI</option>
    </select>
						<span style="color:red" ng-show="model_form.company.$touched && model_form.company.$invalid">*Cannot Leave Empty </span>
						</div>
						<div class="col-md-4 col-sm-6 contact-form1 form-group">
							<label class="col-form-label">Customer</label>
							<select type="text" class="form-control" name="model_no" ng-model="model_no" ng-change="loadModelListByCustomerGroup()" placeholder="" required>
						...
						<span style="color:red" ng-show="model_form.customer.$touched && model_form.customer.$invalid">*Cannot Leave Empty </span>
						
						</div>
						<div class="col-md-4 col-sm-6 contact-form1 form-group">
							<label class="col-form-label">Model Name</label>
							<input type="text" class="form-control" name="model_name" ng-model="model_name" placeholder="Data can be in character or in numeric way" ng-pattern="/^[a-zA-Z0-9]+$/" required>
						 <span style="color:red" ng-show="model_form.model_name.$touched && model_form.model_name.$invalid">*Cannot Leave Empty.Invalid Data Format.</span>
						...
						<div class="col-md-4 col-sm-6 contact-form1 form-group">
							...
							<select type="text" class="form-control" name="user_plant_no" ng-model="user_plant_no" placeholder="" required="">
    ...
    <option value="2">Plant-2</option>
     <option value="3">Plant-5</option>
					...
					<span style="color:red" ng-show="model_form.user_plant_no.$touched && model_form.user_plant_no.$invalid">*Cannot Leave Empty </span>	
						
						</div>
						</div>
					
					<div class="contact-form">
						<input type="submit" value="Submit"  ng-click="insertModelRecord($event)">
